...
interface IWinnerDetailToDeal {
  ...
  lastname: string;
  middle_name: string;
  id_number: string | null; // Null bo'lishi mumkin
//   region: IDirectory;
//   district: IDirectory; // Asosiy obyektda district bitta obyekt
  company_name: string | null;
  stir: string | null;
  phone: string;
  email: string;
//   object: IWinnerObjectDetail[]; // Massiv
  concept: string | null; // URL yoki null
