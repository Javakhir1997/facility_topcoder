...
export const ApplicationService = {
  async getApplications(
    ...
    const res = await interceptor<IListResponse<IApplicationList>>(
      `application${isMOF ? "mof/appeal/list" : isDirector ? "director/appeal/list" : isOperator ? "operator/appeal/list" : ""}`,
      { params: queryParams },
    );
    return res.data;
  },
  ...
  async getApplication(id: number | string) {
    const res = await interceptor<IApplicationDetail>(
      `application/business-owner/${id}`,
    );
    return res.data;
  },
  ...
  async conceptFileGenerate(data: IApplicationForm, id: number | string) {
    ...
    const res = await interceptor.post<IFIle>(
      "application/concept-create",
      newData,
    );
    return res.data;
  },
  ...
  async editApplicationFiles(data: string | number, id: string | number) {
    ...
    const res = await interceptor.patch(
      `application/director/${id}/add_file`,
      newData,
    );
    return res.data;
  },
  ...
  async returnAppeal(
    data: IOperatorReturnAppealForm,
    id: string,
    path: "director" | "operator" | "mof",
  ) {
    const newData = {
      application: id,
    ...
    const res = await interceptor.post(
      `application/${path}/${path === "director" ? "reject" : "return"}`,
      newData,
    );
    return res.data;
  },
  ...
  async sentAppeal(data: ISentForm, id: string) {
    ...
    const res = await interceptor.patch(
      `application/operator/${id}/send-mof`,
      newData,
    );
    return res.data;
  },
  ...
  async replyAppeal(data: IReplyAppealForm, id: string) {
    ...
    const res = await interceptor.post(
      `application/mof/${data.responseType}`,
      newData,
    );
    return res.data;
  },
  ...
  async confirmApplication(data: IConfirmApplicationForm, id: string) {
    const res = await interceptor.post(
      `application/confirm-application/${id}`,
      data,
    );
    return res.data;
  },
  async returnApplication(data: IConfirmApplicationForm, id: string) {
    const res = await interceptor.post(
      `application/rejection-application/${id}`,
      data,
    );
    return res.data;
  },
  ...
  async getConceptions(queryParams: ISearchParams) {
    const res = await interceptor<IListResponse<IConceptionList>>(
      `application/concept`,
      { params: queryParams },
    );
    return res.data;
  ...
  async getConceptionDetail(id: number | string) {
    const res = await interceptor<IConceptionDetail>(
      `application/concept/${id}`,
    );
    return res.data;
  },

  async getWinnerDetailToDeal(id: number | string) {
    const res = await interceptor<IWinnerDetailToDeal>(
      `application/tenders/${id}/get-participant`,
    );
  ...
  async confirmConception(id: number, data: ConfirmConceptionDTO) {
    const res = await interceptor.put<IConceptionDetail>(
      `application/send-region-dxsh/${id}`,
      data,
    );
    return res.data;
  },
  ...
  async sendToMinistryConception(id: number) {
    const res = await interceptor.put<IConceptionDetail>(
      `application/send-concept-to-ministry-dxsh/${id}`,
    );
    return res.data;
  },
  ...
  async evolutionConception(id: number, data: ConfirmConceptionDTO) {
    const res = await interceptor.put<IConceptionDetail>(
      `application/evaluation-by-region-dxsh-or-balans/${id}`,
      data,
    );
    return res.data;
  },
  ...
  async attachPerformerToConception(id: number, data: AttachPerformerDTO) {
    const res = await interceptor.put<IConceptionDetail>(
      `application/attach-performer-to-concept/${id}`,
      data.responsibility,
    );
    return res.data;
  },
