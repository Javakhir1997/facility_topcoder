            ...
            <table className="min-w-max border-collapse bg-white">
              <thead>
                ...
                <tr className="bg-[#005ae6] text-white border-b-2 border-gray-200">
                  ...
                  <th
                    rowSpan={2}
                    className="border border-gray-200 px-2 py-2 text-left text-sm font-bold min-w-40"
                  >
                    Ko'rsatkichlar
                  </th>
...
export default AddFinansPlansDetails;
