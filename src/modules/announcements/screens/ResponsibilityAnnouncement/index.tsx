...
import UseConfirmResponsibilityApplication from "@modules/applications/hooks/useConfirmResponsibilityApplication.ts";
import {
...
import {SetApplicationResponsibilityDTO} from "@entities/application";
...
const Index = () => {
    ...
    const { form, fields, remove, append, responsibilityListOptions, setApplicationResponsibility, isPendingResponsibilityList} = UseConfirmResponsibilityApplication();

    const handleFormSubmit = (data:SetApplicationResponsibilityDTO) => {
        setApplicationResponsibility(data)
    };
