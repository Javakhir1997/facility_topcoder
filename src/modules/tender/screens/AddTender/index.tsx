...
const Index: FC<IProperties> = ({edit = false}) => {
	...
	const handleFinalSubmit = handleSubmit((data) => {
		...
		if (data.balance_organization) formData.append('balance_organization', String(data.balance_organization))
		if (data.object_type) formData.append('object_type', String(data.object_type))
		...
		if (data.indebtedness_file?.id) {
			formData.append('indebtedness_file', data.indebtedness_file?.id?.toString())
		}
		if (data.success_projects_file?.id) {
			formData.append('success_projects_file', data.success_projects_file?.id?.toString())
		}
