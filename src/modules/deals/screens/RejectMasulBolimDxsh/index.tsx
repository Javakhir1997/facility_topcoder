...
import useRejectMasulBolimDxshDeal from "@modules/deals/hooks/useRejectMasulBolimDxshDeal";
import {
        ...
        <PageLayout>
            ...
            <Wrapper>
                <div className="flex gap--5xl items-center">
                    ...
                    {
                        [ROLE_LIST.OPERATOR, ROLE_LIST.HEAD, ROLE_LIST.FINANCE_EMPLOYEE, ROLE_LIST.APPLICANT,ROLE_LIST.MINISTRY_M_B_B].includes(user.role) &&
                        <>
                ...
                <Restricted permittedRole={[ROLE_LIST.MINISTRY_DXSH_B_B, ROLE_LIST.MINISTRY_FINANCE,ROLE_LIST.APPLICANT,ROLE_LIST.MINISTRY,ROLE_LIST.MINISTRY_M_B_B]}>
                    <Form {...form}>
