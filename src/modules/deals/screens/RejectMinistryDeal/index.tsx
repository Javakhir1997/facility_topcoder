...
import useRejectMinistryDeal from "@modules/deals/hooks/useRejectMinistryDeal";
import {
    ...
    return (
        <PageLayout>
            ...
            <Wrapper>
                ...
                <Restricted permittedRole={[ROLE_LIST.MINISTRY_DXSH_B_B, ROLE_LIST.MINISTRY_FINANCE,ROLE_LIST.APPLICANT,ROLE_LIST.MINISTRY]}>
                    <Form {...form}>
